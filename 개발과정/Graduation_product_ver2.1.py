...
def Word_education_double(event):
    ...
    global word_list, word_index, word_double_flag, word_len
    word_index = 0
    ...
    def Map_wrd(x):
        ...
        if(word_double_flag):
            ...
            voice_timmer(x[0],x[0],3)
        #os.system("mpg321 ./sound/"+string+".mp3")    
            ...
            for c in range(0,4):
                if(index < word_len):
                    ...
                    word_button = tkinter.Button(frame,
                                        ...
                                        width=8,
                                        command=wrd)
                    word_button.bind("<Double-Button-1>",Sel_double)
    ...
    frame_button_l.bind("<Double-Button-1>",Next_double)
